...
public class SortServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        if (sort.equals("asc")||sort.equals("")) {
            List<Product> listSortAsc = dao.sortByPriceAsc();
            request.setAttribute("listPaging", listSortAsc);
        } else {
            List<Product> listSortDesc = dao.sortByPriceDesc();
            request.setAttribute("listPaging", listSortDesc);
        }
