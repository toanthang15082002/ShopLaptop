...
<html lang="en">
    ...
    <body>
        <div class="container">
                    ...
                    <tbody>
                        <c:forEach items="${listPaging}" var="o">
                            <tr>
                                ...
                                <td><fmt:formatNumber pattern="#,##0" value="${o.price}"/> VND</td>
                                <td>${o.sell}</td>
                                <td>
            ...
            <p>Total product was selled: ${total}</p>
                ...
                <div class="modal-content">
                    <form action="add" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>Screen</label>
                                <input name="screen" type="text" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Disk</label>
                                <input name="disk" type="text" class="form-control" required>
                            </div>
                            <div class="form-group">
